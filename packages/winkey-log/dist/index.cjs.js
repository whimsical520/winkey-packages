...
class LogSpinner {
    ...
    failSpinner(text) {
        spinner.stopAndPersist({
            symbol: '☠️',
            text: chalk$1.red(text)
        });
    }
    addSpinner(text) {
        spinner.stopAndPersist({
            symbol: '😏',
            text: chalk$1.greenBright(text)
        });
    }
    updateSpinner(text) {
        spinner.stopAndPersist({
            symbol: '😮',
            text: chalk$1.dim(text)
        });
    }
    warnSpinner(text) {
        spinner.stopAndPersist({
            symbol: '😡',
            text: chalk$1.yellow(text)
        });
    }
    cmdSpinner(text) {
        spinner.stopAndPersist({
            symbol: '👻',
            text: chalk$1.white(text)
        });
    }
    waitSpinner(text) {
        if (this.timer)
...
const logger = (type, text) => {
    switch (type) {
        case exports.LogType.Start:
            logSpinner.startSpinner(text);
            break;
        case exports.LogType.Add:
            logSpinner.addSpinner(text);
            break;
        case exports.LogType.Cmd:
            logSpinner.cmdSpinner(text);
            break;
        case exports.LogType.Error:
            logSpinner.failSpinner(text);
            break;
        case exports.LogType.Info:
            logSpinner.infoSpinner(text);
            break;
        case exports.LogType.Success:
            logSpinner.succeedSpiner(text);
            break;
        case exports.LogType.Update:
            logSpinner.updateSpinner(text);
            break;
        case exports.LogType.Warn:
            logSpinner.warnSpinner(text);
            break;
        case exports.LogType.Wait:
            logSpinner.waitSpinner(text);
            break;
        case exports.LogType.Tip:
            logSpinner.tipSpinner(text);
            break;
        case exports.LogType.Correct:
            logSpinner.correctSpinner(text);
            break;
        case exports.LogType.Delete:
            logSpinner.deleteSpinner(text);
            break;
        case exports.LogType.Finish:
